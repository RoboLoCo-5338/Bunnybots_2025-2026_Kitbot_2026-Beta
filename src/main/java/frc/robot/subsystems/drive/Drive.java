...
public class Drive extends SubsystemBase {
  ...
  private final double kS = Constants.CURRENT_MODE == Mode.SIM ? simKs : realKs;
  private final double kV = Constants.CURRENT_MODE == Mode.SIM ? simKv : realKv;
  ...
  public void periodic() {
    ...
    Logger.processInputs("Drive", (LoggableInputs) inputs);
    Logger.processInputs("Drive/Gyro", (LoggableInputs) inputs);
